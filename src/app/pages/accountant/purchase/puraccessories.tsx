...
drCr:
  ...
  if (terms === "Bank" && !bankAccount) {
    ...
    return;
      ...
      if (isEdit) {
        await apiHelper.put(`/accountant/accessories-purchase/${id}`, payload);
        toast.success("Purchase Updated Successfully");
      } else {
        await apiHelper.post("/accountant/accessories-purchase", payload);
  ...
  const handleVerify = async () => {
    ...
    try {
      await apiHelper.put(`/accountant/accessories-purchase/verify/${id}`, {});
