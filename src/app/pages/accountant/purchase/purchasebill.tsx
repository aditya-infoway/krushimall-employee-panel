...
const TractorPurchaseBill: React.FC<TractorPurchaseBillProps> = ({
  ...
  const handleCreateAccount = async () => {
    try {
      ...
      const res = await apiHelper.post("/accountant/accounts", {
  ...
  const getPurchase = async (id: string) => {
    try {
      const res = await apiHelper.get(`/accountant/purchases/${id}`);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isEdit) {
        await apiHelper.put(`/accountant/purchases/${id}`, payload);
        toast.success("Purchase Updated Successfully");
      } else {
        await apiHelper.post("/accountant/purchases", payload);
  ...
  const handleVerify = async () => {
    try {
      await apiHelper.put(`/accountant/purchases/${id}/verify`, null);
