...
const fetchAccessoriesPurchases = async () => {
  try {
    const res = await apiHelper.get("/accountant/accessories-purchase");
...
const performDelete = async () => {
  ...
  try {
    if (isBulkDelete) {
      await Promise.all(selectedIds.map((id) => apiHelper.delete(`/accountant/accessories-purchase/${id}`)));
      ...
      await apiHelper.delete(`/accountant/accessories-purchase/${deleteTargetId}`);
