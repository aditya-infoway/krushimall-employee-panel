    ...
    <div className="dark:bg-dark-800 min-h-screen bg-gray-50 p-3 sm:p-4 lg:p-5 xl:p-6">
      <div className="mx-auto w-full max-w-480">
        ...
        <div className="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            <Combobox
              data={bankAccountOptions.map((acc) => ({
                label: acc.name,
                value: acc.id,
                mobile: acc.mobile,
              ...
              value={
                bankAccount
                  ? {
                      label:
                        bankAccountOptions.find((acc) => acc.id === bankAccount)
                          ?.name || "",
                      value: bankAccount,
                      mobile:
                        bankAccountOptions.find((acc) => acc.id === bankAccount)
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tfoot>
                <tr className="dark:bg-dark-700 border bg-white dark:border-black">
                  ...
                  {/* Spans Mode, Cheque No, Cheque Date, Clear Date, Narration, Created Type, Created By */}
                  <td
                    colSpan={7}
                    className="px-3 py-2.5 text-right text-sm font-bold text-gray-900 dark:text-white"
                  >
