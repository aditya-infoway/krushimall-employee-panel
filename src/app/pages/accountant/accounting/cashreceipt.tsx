...
const getLeads = async () => {
  ...
  const getCashReceipts = async () => {
    try {
      const res = await apiHelper.get("/accountant/cash-receipt");
...
const getVoucherNo = async () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editId) {
        await apiHelper.put(`/accountant/cash-receipt/${editId}`, payload);
        toast.success("Cash receipt updated successfully!");
      } else {
        await apiHelper.post("/accountant/cash-receipt", payload);
