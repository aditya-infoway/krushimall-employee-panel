...
//   try {
//      const res = await apiHelper.get("/salesexecutive/lead");

//     setLeadData(Array.isArray(res.data?.data) ? res.data.data : []);
//   } catch (error) {
...
const handleDeliveryChallan = (leadId: number) => {
  window.open(
    `${getBaseUrl()}/api/salesexecutive/order/lead/${leadId}/delivery-challan`,
    "_blank"
  );
};
  return (
                    ...
                    <div className="flex w-full flex-col gap-1.5">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex-1 cursor-pointer rounded-full border border-yellow-500 py-1 px-4 text-[12px] text-yellow-600 hover:bg-yellow-50 dark:hover:bg-yellow-900/20"
                        >
                          Send Quotation
                        </button>
